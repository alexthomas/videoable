module Videoable
    module VideoUploader
      ...
      included do
        ...
        class << self
          @@api = Videoable::Apis::Vimeo::Video.new
        end
      ...
      def populate_video_fields_from_remote vid,service
        vf = "Videoable::Feeds::#{service.camelize}::VideoFeed".constantize.new :vid => vid
        video = "Videoable::Feeds::#{service.camelize}::VideoFeed".constantize.parse_feed vf.url,vf.vid #parse feed should generate error parsing video error
